#ifndef __PRINT_UTILITIES__
#define __PRINT_UTILITIES__
...
void construct_state_sentence(unsigned long timestamp, double pressure_0, double pressure, rocket_state_t my_state, char* sentence_buffer) {
